...
<body>
  ...
  <div class="container">
            ...
            <div class="form-group" name="location">
              ...
              <div id="inside_chennai_options">
                <select id="location" name="location" class="form-control" required
                  onchange="updateLocationValue(); updateRoutes();">
    ...
    function toggleLocationFields() {
        ...
        if (outsideChennaiRadio.checked) {
            insideChennaiOptions.style.display = 'none';
            outsideChennaiOptions.style.display = 'block';
            document.getElementById('routes').value = '7'; // Set routes value to 7 for outside Chennai
            updateLocationValue(); // Update location value when outside Chennai is selected
        } else {
    ...
    // Add an event listener to the input field outside_chennai_location to update selected_location on input change
    document.getElementById('outside_chennai_location').addEventListener('input', function() {
        updateLocationValue();
    });
</script>
