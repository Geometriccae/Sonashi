                ...
                <div class="card">
                    ...
                    <div class="d-flex p-3">
                            ...
                            <div class="ms-auto text-end">
                                <h4 class="font-size-18">Welcome User!</h4>
                                <p class="text-muted mb-0">Sign in as a User.</p>
                            </div>
                        </div>
                        <form method="POST" action="user_action.php" class="needs-validation" novalidate="" autocomplete="off">
                    <div class="mb-3">
                        <label class="mb-2 text-muted" for="user_email">E-Mail Address</label>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form method="POST" action="<?php echo base_url('index.php/user/index'); ?>" class="needs-validation" novalidate="" autocomplete="off">
                                <div class="mb-3">
                                    <label class="mb-2 text-muted" for="user-email">E-Mail Address</label>
                                    <input id="user-email" type="email" class="form-control" name="user_email" value="" required autofocus>
                                </div>

                                <div class="mb-3">
                                    <label class="mb-2 text-muted" for="user-password">Password</label>
                                    <input id="user-password" type="password" class="form-control" name="user_password" required>
                                </div>

                                <div class="d-flex align-items-center">
                                    <button type="submit" class="btn btn-primary ms-auto">Login as User</button>
                                </div>
                            </form>
                        </div>
                        <div class="card-footer py-3 border-0">
                            <div class="text-center">
                                Don't have a user account? <a href="<?php echo base_url(); ?>user/register" class="text-dark">Create One</a>
                            </div>
                        </div>
                    </div>
                </div>
