                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-5 col-xl-4">
                                ...
                                <div class="d-flex p-3">
                                    <div>
                                        <a  href="<?php echo base_url();?>index.html" class="">
                                            <img src="<?php echo base_url();?>assets/images/logo_dark.png" alt="" height="22" class="auth-logo logo-dark">
                                            <img src="<?php echo base_url();?>assets/images/logo.png" alt="" height="22" class="auth-logo logo-light">
                                        </a>
                                    </div>
                        ...
                        <div class="mt-5 text-center position-relative">
                            <p class="text-white-50">Don't have an account ? <a  href="<?php echo base_url();?>pages-register.html" class="fw-bold text-white"> Signup Now </a> </p>
